...
<h2 align="center" style="font-weight:bold; margin-top:0px; padding-top:30px">Generate Payment Recovery Reports</h2>
<div class="row">
    <div class="col-lg-12 ">
        <div class="panel panel-default">
            <div class="panel-heading">
                <i class="fa fa-bar-chart-o fa-fw"></i> Generate Recovery Reports
            </div>
                <!-- /.panel-heading -->
                
            <div class="panel-body">
                <div class="row" align="center">
                    <form action="{{route('genrecoveryreport')}}" method="post">
